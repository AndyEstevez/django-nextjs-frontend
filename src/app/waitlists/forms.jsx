...
export default function WaitlistForm() {
  ...
  return <form onSubmit={handleSubmit} className="space y-4">
    ...
    <div className="grid gap-2">
        ...
        <div className={errors?.email ? "rounded-lg p-3 border border-destructive bg-destructive" : ''}>
            <Input 
                id="email"
                type="email"
                name="email"
            ...
            />
            <div>
                {errors?.email && <div className="p-1 text-sm bg-destructive text-center text-white">
